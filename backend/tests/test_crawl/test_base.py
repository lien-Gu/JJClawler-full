...
class TestCrawlConfig:
    ...
    def test_init_with_valid_config(self, mock_urls_config):
        """测试使用有效配置初始化"""
    ...
    def test_init_with_empty_global_section(self):
        """测试空global配置段的初始化"""
    ...
    def test_get_task_config_existing_task(self, mock_urls_config):
        """测试获取存在的任务配置"""
        mock_config_content = json.dumps(mock_urls_config)
    ...
    def test_get_task_config_nonexistent_task(self, mock_urls_config):
        """测试获取不存在的任务配置"""
        mock_config_content = json.dumps(mock_urls_config)
    ...
    def test_get_all_tasks(self, mock_urls_config):
        """测试获取所有任务配置"""
        mock_config_content = json.dumps(mock_urls_config)
    ...
    def test_get_all_tasks_empty_config(self):
        """测试获取空任务配置"""
        config_data = {"global": {}, "crawl_tasks": []}
        mock_config_content = json.dumps(config_data)
    ...
    def test_get_all_tasks_missing_crawl_tasks(self):
        """测试缺少crawl_tasks配置"""
        config_data = {"global": {}}
        mock_config_content = json.dumps(config_data)
    ...
    def test_build_url_success(self, mock_urls_config):
        """测试成功构建URL"""
        mock_config_content = json.dumps(mock_urls_config)
    ...
    def test_build_url_with_override_params(self, mock_urls_config):
        """测试使用覆盖参数构建URL"""
        mock_config_content = json.dumps(mock_urls_config)
    ...
    def test_build_url_nonexistent_template(self, mock_urls_config):
        """测试使用不存在的模板构建URL"""
        mock_config_content = json.dumps(mock_urls_config)
    ...
    def test_build_url_no_params(self, mock_urls_config):
        """测试无额外参数构建URL"""
        mock_config_content = json.dumps(mock_urls_config)
    ...
    def test_build_url_novel_detail_template(self, mock_urls_config):
        """测试构建书籍详情URL"""
        mock_config_content = json.dumps(mock_urls_config)
...
class TestHttpClient:
    ...
    @pytest.mark.asyncio
    async def test_multiple_requests_delay(self):
        """测试多个请求之间的延迟"""
        import time
    ...
    @pytest.mark.asyncio
    async def test_get_with_valid_json_response(self):
        """测试有效JSON响应"""
        expected_data = {
            "status": "success",
            "data": [
