...
class TestAPISettings:
    ...
    def test_environment_variables(self):
        ...
        with patch.dict(
            os.environ,
            {"API_TITLE": "Test API", "API_PORT": "9000", "API_DEBUG": "true"},
        ):
            settings = APISettings()
...
class TestSettings:
    ...
    def test_ensure_directories(self, mock_mkdir):
        """测试目录创建功能"""
        settings = Settings(data_dir="./test_data", logs_dir="./test_logs")
    ...
    def test_nested_settings_configuration(self):
        ...
        settings = Settings(database=custom_database, api=custom_api)
    ...
    def test_complex_configuration_scenario(self):
        ...
        settings = Settings(
            ...
            crawler=CrawlerSettings(
                timeout=45, retry_times=5, request_delay=2.0, concurrent_requests=2
            ),
