...
class TestGetRankings:
    ...
    def test_get_rankings_success(self, client, mocker, mock_ranking_data):
        ...
        mock_service.get_all_rankings.return_value = {
            "rankings": [type('MockRanking', (), ranking)() for ranking in mock_ranking_data["ranking_list"]],
            "total": 2
        }
    ...
    def test_get_rankings_with_filter(self, client, mocker, mock_ranking_data):
        ...
        mock_service = mocker.patch('app.api.rankings.ranking_service')
        mock_service.get_all_rankings.return_value = {
            "rankings": [type('MockRanking', (), mock_ranking_data["ranking_list"][0])()],
            "total": 1
        }
...
class TestGetRankingHistory:
    ...
    def test_get_ranking_history_success(self, client, mocker):
        ...
        # 发送请求
        response = client.get("/api/v1/rankings/1/history?start_date=2024-01-01&end_date=2024-01-15")
...
class TestGetRankingStats:
    ...
    def test_get_ranking_stats_success(self, client, mocker, mock_ranking_data, mock_ranking_stats):
        """测试成功获取榜单统计"""
        # 模拟service
        mock_service = mocker.patch('app.api.rankings.ranking_service')
        mock_service.get_ranking_by_id.return_value = type('MockRanking', (), mock_ranking_data["ranking"])()
...
class TestCompareRankings:
    ...
    def test_compare_rankings_success(self, client, mocker, mock_comparison_data):
        ...
        comparison_result["ranking_data"] = MockRankingData(comparison_result["ranking_data"])
